...
**[Hello Rails Frontend]** This App connect React front-end with a Rails back-end and to display a random message.
...
- [Backend Link](https://github.com/MargaretTechworld/hello-rails-back-end)
...
*git clone git@github.com:MargaretTechworld/hello-react-front-end.git
...
Feel free to check the [issues page](https://github.com/MargaretTechworld/hello-react-front-end/issues).
